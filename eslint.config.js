    ...
    rules: {
      ...
      "import/no-restricted-paths": ["error", {
        zones: [
          ...
          {
            target: ["./src/components", "./src/hooks", "./src/lib", "./src/utils", "./src/config", "./src/assets"],
            from: "./src/app",
          ...
          // The non-UI core (config/lib/utils) must not depend on React layers.
          {
            ...
            message: "config/lib/utils are framework-agnostic — don't import components or hooks.",
          },
        ],
      }],
    },
